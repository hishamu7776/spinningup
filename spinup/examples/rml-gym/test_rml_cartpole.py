...
if __name__ == "__main__":
    ...
    if "spinup" in cwd:
        if "examples" in cwd:
            if "rml-gym" in cwd:
                log_directory = "./logs/rml_cartpole/"
                fig_directory = "./logs/figures/rml_cartpole/"
            else:
                log_directory = "./rml-gym/logs/rml_cartpole/"
                fig_directory = "./rml-gym/logs/figures/rml_cartpole/"
        else:
            log_directory = "./examples/rml-gym/logs/rml_cartpole/"
            fig_directory = "./examples/rml-gym/logs/figures/rml_cartpole/"
    else:
        log_directory = "/tmp/logs/ppo/cartpole/"
        fig_directory = "/tmp/logs/ppo/cartpole/figures/rml_cartpole/"

    stl_env_config_dense = args['config_path'] + "stl_dense_cartpole.yaml"
    stl_env_config_sparse = args['config_path'] + "stl_sparse_cartpole.yaml"
    rml_env_config = args['config_path'] + "rml_cartpole.yaml"
