...
if __name__ == "__main__":
    ...
    if "spinup" in cwd:
        if "examples" in cwd:
            if "rml-gym" in cwd:
                log_directory = "./logs/rml_pendulum/"
                fig_directory = "./logs/figures/rml_pendulum/"
            else:
                log_directory = "./rml-gym/logs/rml_pendulum/"
                fig_directory = "./rml-gym/logs/figures/rml_pendulum/"
        else:
            log_directory = "./examples/rml-gym/logs/rml_pendulum/"
            fig_directory = "./examples/rml-gym/logs/figures/rml_pendulum/"
    else:
        log_directory = "/tmp/logs/ppo/pendulum/"
        fig_directory = "/tmp/logs/ppo/pendulum/figures/rml_pendulum/"
