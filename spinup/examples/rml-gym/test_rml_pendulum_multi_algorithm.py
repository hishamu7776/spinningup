...
if __name__ == "__main__":
    ...
    if "spinup" in cwd:
        if "examples" in cwd:
            if "rml" in cwd:
                log_directory = "./logs/test_rml_multiple_algorithms_pendulum/"
                fig_directory = "./logs/figures/test_rml_multiple_algorithms_pendulum/"
            else:
                log_directory = "./rml/logs/test_rml_multiple_algorithms_pendulum/"
                fig_directory = "./rml/logs/figures/test_rml_multiple_algorithms_pendulum/"
        else:
            log_directory = "./examples/rml/logs/test_rml_multiple_algorithms_pendulum/"
            fig_directory = "./examples/rml/logs/figures/test_rml_multiple_algorithms_pendulum/"
    else:
        log_directory = "/tmp/logs/ppo/pendulum/"
        fig_directory = "/tmp/logs/ppo/pendulum/figures/test_rml_multiple_algorithms_pendulum/"
