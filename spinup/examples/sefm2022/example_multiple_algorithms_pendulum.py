    ...
    if "spinup" in cwd:
        if "examples" in cwd:
            if "sefm2022" in cwd:
                ...
                log_directory = "./sefm2022/logs/ex_multiple_algorithms_pendulum/"
                fig_directory = "./sefm2022/logs/figures/ex_multiple_algorithms_pendulum/"
        else:
            log_directory = "./examples/sefm2022/logs/ex_multiple_algorithms_pendulum/"
            fig_directory = "./examples/sefm2022/logs/figures/ex_multiple_algorithms_pendulum/"
    else:
