    ...
    if "spinup" in cwd:
        if "examples" in cwd:
            if "sefm2022" in cwd:
                ...
                log_directory = "./sefm2022/logs/ex_retrain_cartpole/"
                fig_directory = "./sefm2022/logs/figures/ex_retrain_cartpole/"
        else:
            log_directory = "./examples/sefm2022/logs/ex_retrain_cartpole/"
            fig_directory = "./examples/sefm2022/logs/figures/ex_retrain_cartpole/"
    else:
