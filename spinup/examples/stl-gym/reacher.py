...
if __name__ == "__main__":
    ...
    if "spinup" in cwd:
        if "examples" in cwd:
            if "stl-gym" in cwd:
                log_directory = "./logs/ppo/reacher/"
            else:
                log_directory = "./stl-gym/logs/ppo/reacher/"
        else:
            log_directory = "./examples/stl-gym/logs/ppo/reacher/"
    else:
        log_directory = "/tmp/logs/ppo/reacher/"
    ...
    if args['baseline']:
        for i in range(len(random_seeds)):
            env_fn = partial(gym.make, 'Reacher-v2')
            test_env_fn = partial(gym.make, 'Reacher-v2')
            ...
            original_env = gym.make('Reacher-v2')
