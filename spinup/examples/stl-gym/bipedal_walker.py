...
if __name__ == "__main__":
    ...
    if "spinup" in cwd:
        if "examples" in cwd:
            if "stl-gym" in cwd:
                log_directory = "./logs/ppo/bipedal_walker/"
            else:
                log_directory = "./stl-gym/logs/ppo/bipedal_walker/"
        else:
            log_directory = "./examples/stl-gym/logs/ppo/bipedal_walker/"
    else:
        log_directory = "/tmp/logs/ppo/bipedal_walker/"
    stl_env_config = args['config_path'] if args['config_path'] is not None else './configs/bipedal_walker.yaml'
