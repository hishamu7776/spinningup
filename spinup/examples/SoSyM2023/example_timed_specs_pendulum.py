...
if __name__ == "__main__":
    ...
    if "spinup" in cwd:
        if "examples" in cwd:
            if "SoSyM2023" in cwd:
                log_directory = "./logs/ex_timed_specs_pendulum/"
                fig_directory = "./logs/figures/ex_timed_specs_pendulum/"
            else:
                log_directory = "./SoSyM2023/logs/ex_timed_specs_pendulum/"
                fig_directory = "./SoSyM2023/logs/figures/ex_timed_specs_pendulum/"
        else:
            log_directory = "./examples/SoSyM2023/logs/ex_timed_specs_pendulum/"
            fig_directory = "./examples/SoSyM2023/logs/figures/ex_timed_specs_pendulum/"
    else:
        log_directory = "/tmp/logs/ppo/pendulum/"
        fig_directory = "/tmp/logs/ppo/pendulum/figures/ex_timed_specs_pendulum/"
    stl_env_config_pendulum = args['config_path'] + "ex_timed_specs_pendulum.yaml"
    stl_env_config_pendulum_eval = args['config_path'] + "ex_timed_specs_pendulum_eval.yaml"
