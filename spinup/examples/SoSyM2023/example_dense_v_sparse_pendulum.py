    ...
    if "spinup" in cwd:
        if "examples" in cwd:
            if "SoSyM2023" in cwd:
                ...
                log_directory = "./SoSyM2023/logs/ex_dense_v_sparse_pendulum/"
                fig_directory = "./SoSyM2023/logs/figures/ex_dense_v_sparse_pendulum/"
        else:
            log_directory = "./examples/SoSyM2023/logs/ex_dense_v_sparse_pendulum/"
            fig_directory = "./examples/SoSyM2023/logs/figures/ex_dense_v_sparse_pendulum/"
    else:
