...
if __name__ == "__main__":
    ...
    if "spinup" in cwd:
        if "examples" in cwd:
            if "SoSyM2023" in cwd:
                log_directory = "./logs/ex_conditional_pendulum/"
                fig_directory = "./logs/figures/ex_conditional_pendulum/"
            else:
                log_directory = "./SoSyM2023/logs/ex_conditional_pendulum/"
                fig_directory = "./SoSyM2023/logs/figures/ex_conditional_pendulum/"
        else:
            log_directory = "./examples/SoSyM2023/logs/ex_conditional_pendulum/"
            fig_directory = "./examples/SoSyM2023/logs/figures/ex_conditional_pendulum/"
    else:
        log_directory = "/tmp/logs/ppo/pendulum/"
        fig_directory = "/tmp/logs/ppo/pendulum/figures/ex_conditional_pendulum/"
    stl_env_config_pendulum = args['config_path'] + "ex_conditional_pendulum_eval.yaml"
    stl_env_config_pendulum_eval = args['config_path'] + "ex_conditional_pendulum_eval.yaml"
    ...
    if args['plot_traces']:
        ...
        for i in random_seeds:
            ...
            save_name = fig_directory + "timed_pendulum_rand_seed_" + str(i) + "_traces.png"
