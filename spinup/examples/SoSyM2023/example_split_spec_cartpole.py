    ...
    if "spinup" in cwd:
        if "examples" in cwd:
            if "SoSyM2023" in cwd:
                ...
                log_directory = "./SoSyM2023/logs/ex_split_spec_cartpole/"
                fig_directory = "./SoSyM2023/logs/figures/ex_split_spec_cartpole/"
        else:
            log_directory = "./examples/SoSyM2023/logs/ex_split_spec_cartpole/"
            fig_directory = "./examples/SoSyM2023/logs/figures/ex_split_spec_cartpole/"
    else:
